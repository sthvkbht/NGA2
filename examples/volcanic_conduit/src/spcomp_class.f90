      ...
      do k=this%cfg%kmin_,this%cfg%kmax_
         do j=this%cfg%jmin_,this%cfg%jmax_
            do i=this%cfg%imin_,this%cfg%imax_
               ...
               ! Gravity
               dQdt(i,j,k,3)=dQdt(i,j,k,3)+0.5_WP*sum(this%Q(i-1:i,j,k,1))*this%gravity(1)
               dQdt(i,j,k,4)=dQdt(i,j,k,4)+0.5_WP*sum(this%Q(i,j-1:j,k,1))*this%gravity(2)
               dQdt(i,j,k,5)=dQdt(i,j,k,5)+0.5_WP*sum(this%Q(i,j,k-1:k,1))*this%gravity(3)
